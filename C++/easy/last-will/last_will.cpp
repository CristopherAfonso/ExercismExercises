...
int estate_executor::assemble_code() {
    const int kSumRedFragments{zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()};
    const int kSumBlueFragments{zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment()};
    
    return kSumRedFragments * kSumBlueFragments;
}
